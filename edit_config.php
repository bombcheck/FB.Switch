...
$r_FBmilightID = (string)$_POST['FBmilightID'];
$r_FBmilightIP = (string)$_POST['FBmilightIP'];
$r_FBmilightUsername = (string)$_POST['FBmilightUsername'];
$r_FBmilightPassword = (string)$_POST['FBmilightPassword'];
...
$r_showSplashAnimation = (string)$_POST['showSplashAnimation'];
...
switch ($r_action) {
    ...
    case "edit":
        ...
        $xml->milighthubs->milighthub->id = $r_FBmilightID;
        $xml->milighthubs->milighthub->address = $r_FBmilightIP;
        $xml->milighthubs->milighthub->username = $r_FBmilightUsername;        
        $xml->milighthubs->milighthub->password = $r_FBmilightPassword;
	...
	case "editdesign":
        ...
        $xml->gui->playSounds = $r_playSounds;
        $xml->gui->showSplashAnimation = $r_showSplashAnimation;
