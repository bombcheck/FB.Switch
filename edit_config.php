...
$r_FBNETbackendURL = (string)$_POST['FBNETbackendURL'];
$r_FBNETsidSource = (string)$_POST['FBNETsidSource'];
$r_EnableLoggingToBE = (string)$_POST['EnableLoggingToBE'];
...
switch ($r_action) {
    ...
    case "edit":
        ...
        $xml->backend->url = $r_FBNETbackendURL;
        $xml->backend->sidsource = $r_FBNETsidSource;
        $xml->backend->logging = $r_EnableLoggingToBE;
